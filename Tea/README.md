...
TeaInfoapp is an Android application for tea scanning, tea recognition, and local analytics. It performs on-device processing with CameraX, ML Kit, Room, and TensorFlow Lite.
